...
;(function (window) {
    ...
    SelectFx.prototype.options = {
        newTab: true, stickyPlaceholder: true, onChange: function (val) {
            return false;
        }
    }
...
;(function (window) {
    'use strict';
    var support = {animations: Modernizr.cssanimations}, animEndEventNames = {
    ...
    FForm.prototype.options = {
        ctrlProgress: true, ctrlNavDots: true, ctrlNavPosition: true, onReview: function () {
            return false;
        }
    };
    ...
    FForm.prototype._addControls = function () {
        ...
        this.ctrlContinue = createElement('button', {cName: 'fs-continue', inner: 'التالي', appendTo: this.ctrls});
    ...
    FForm.prototype._nextField = function (backto) {
        ...
        var self = this, onEndAnimationFn = function (ev) {
    ...
    FForm.prototype._showError = function (err) {
        ...
        switch (err) {
            case'NOVAL':
                message = 'يرجى تعبة البيانات للاستمرار';
                break;
            case'INVALIDEMAIL':
                message = 'يرجى ادخال بريد صحيح';
                break;
        }
...
function showHideLoad(hideIndicator) {
...
//div.classList.toggle("visible");
    if (typeof hideIndicator === "undefined" || hideIndicator === null) {
        ...
        div.classList.add("showw");
        //$('#overlay').show();
    } else {
        div.classList.remove("showw");
        //$('#overlay').hide();
    }
}
